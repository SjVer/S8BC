...
char* opcode_to_string(opcode opcode) {
    switch (opcode) {
        ...
        case OP_CMP_IMM: return "cmp imm";
        case OP_CMP_OPX: return "cmp opx";
        case OP_CMP_OPY: return "cmp opy";
        case OP_CMP_ABS: return "cmp abs";
        case OP_JMP:     return "jmp";
        case OP_JZS:     return "jzs";
        case OP_JZN:     return "jzn";
        case OP_JCS:     return "jcs";
        case OP_JCN:     return "jcn";
        case OP_JES:     return "jes";
        case OP_JEN:     return "jen";
        case OP_JLS:     return "jls";
        case OP_JLN:     return "jln";
        case OP_JGS:     return "jgs";
        case OP_JGN:     return "jgn";
